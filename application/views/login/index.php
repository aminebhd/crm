...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Almokawil CRM</title>
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta content="width=device-width, initial-scale=1" name="viewport" />
        <meta content="Almokawil CRM Project" name="description" />
        ...
        <link href="<?php echo base_url(); ?>public/assets/pages/css/login-5.min.css" rel="stylesheet" type="text/css" />
        ...
        <div class="user-login-5">
            <div class="row bs-reset">
                <div class="col-md-6 bs-reset mt-login-5-bsfix">
                    <div class="login-bg" style="background-image:url(<?php echo base_url(); ?>public/assets/pages/img/login/bg1.jpg)">
                        <img class="login-logo" src="<?php echo base_url(); ?>public/assets/pages/img/login/logo.png" /> </div>
                </div>
                <div class="col-md-6 login-container bs-reset mt-login-5-bsfix">
                    <div class="login-content">
                        <h1>LA GESTION EST DEVENU PLUS FACILE</h1>
                        <p> Qu‘il s‘agisse d‘organiser vos projets, de calculer votre rentabilité ou de simplifier votre comptabilité, Sellsy vous apporte tous les outils pour piloter efficacement votre activité.</p>
                        <form action="<?php echo base_url(); ?>login/index" class="login-form" method="post">
                        ...
                        <form class="forget-form" action="<?php echo base_url(); ?>login/forgot" method="post">
                        ...
                        <div class="row bs-reset">
                            ...
                            <div class="col-xs-7 bs-reset">
                                <div class="login-copyright text-right">
                                    <p>Copyright &copy; Almokawil 2017</p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<![endif]-->
        ...
        <script src="<?php echo base_url(); ?>public/assets/pages/scripts/login-5.min.js" type="text/javascript"></script>
