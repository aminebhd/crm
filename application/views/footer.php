...
<![endif]-->
        ...
        <script src="<?php echo base_url(); ?>public/assets/global/plugins/jquery-validation/js/jquery.validate.js" type="text/javascript"></script>
        ...
        <script src="<?php echo base_url(); ?>public/assets/pages/scripts/table-datatables-buttons.min.js" type="text/javascript"></script>
        <!-- END THEME GLOBAL SCRIPTS -->
        <!-- BEGIN PAGE LEVEL SCRIPTS -->
        <script src="<?php echo base_url(); ?>public/assets/pages/scripts/main.js" type="text/javascript"></script>
