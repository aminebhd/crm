<div class="profile">
    <div class="tabbable-line tabbable-full-width">
        <ul class="nav nav-tabs">
            ...
            <li>
                <a href="#tab_1_6" data-toggle="tab"> Contrat </a>
            </li>
        </ul>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <ul class="list-unstyled profile-nav">
                            <li>
                                <img src="<?php echo base_url(); ?>public/assets/pages/media/profile/20160409_124650.jpg" class="img-responsive pic-bordered" alt="" />
                    ...
                    <div class="col-md-9">
                        <div class="row">
                            <div class="col-md-8 profile-info">
                                <h1 class="font-green sbold uppercase">Amine Bouhaddi</h1>
                                <p> Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt laoreet dolore magna aliquam tincidunt erat volutpat laoreet dolore magna aliquam tincidunt erat
                                    volutpat. </p>
                                <p>
                                    <a href="javascript:;"> contact@dothostia.com </a>
                                </p>
                                <ul class="list-inline">
                                    <li>
                                        <i class="fa fa-map-marker"></i> Marocain </li>
                                    <li>
                                        <i class="fa fa-calendar"></i> 11 Fev 1991 </li>
                                    <li>
                                        <i class="fa fa-briefcase"></i> Responsable Technique </li
                                </ul>
                            </div>
                            <!--end col-md-8-->
                            <div class="col-md-4">
                                <div class="portlet sale-summary">
                                    ...
                                    <div class="portlet-body">
                                        <ul class="list-unstyled">
                                            <li>
                                                <span class="sale-info"> SALAIRE BRUT
                                                    <i class="fa fa-img-up"></i>
                                                </span>
                                                <span class="sale-num"> 10860.00 </span>
                                            </li>
                                            <li>
                                                <span class="sale-info"> SALAIRE NET
                                                    <i class="fa fa-img-down"></i>
                                                </span>
                                                <span class="sale-num"> 9000.00 </span>
                                            </li>
                                            <li>
                                                <span class="sale-info"> Ancienneté </span>
                                                <span class="sale-num"> 4 ans </span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="tabbable-line tabbable-custom-profile">
                            <ul class="nav nav-tabs">
                                ...
                                <li>
                                    <a href="#tab_1_22" data-toggle="tab"> Conservatoire </a>
                                </li>
                            </ul>
                            <div class="tab-content">
