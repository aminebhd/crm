<div class="modal fade" id="editcategories" tabindex="-1" role="basic" aria-hidden="true">
                                   ...
                                   <table class="table table-hover table-light">
                                      ...
                                      <tbody>
                                         ...
                                         <tr>
                                            ...
                                            <td>
                                               <input type="checkbox" id="editcategories-<?= $value->cot_id; ?>" name="cat_value[]" value="<?= $value->cot_id; ?>">
                                            </td>
                                         </tr>
                                         <?php endforeach; ?>
                                      </tbody>
